...
<html>
	...
	<head>
		<title>Welcome  To crime awearness Social media site post</title>
...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="Biobook"><b>Crime Awearness</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
				...
				<li><a href="photos.php" title="Settings"><label>Post</label></a></li>
